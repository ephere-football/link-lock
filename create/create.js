...
async function onEncrypt() {
  ...
  const encrypted = await generateFragment(url, password, hint, useRandomSalt,
      useRandomIv);
  const output = `https://ephere-football.github.io/link-lock/#${encrypted}`;

  document.querySelector("#output").value = output;
  highlight("output");

  // Adjust "Hidden Bookmark" link
  document.querySelector("#bookmark").href = `https://ephere-football.github.io/link-lock/hidden/#${encrypted}`;
