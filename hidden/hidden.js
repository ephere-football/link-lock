...
async function onHide() {
  ...
  try {
    ...
    error("The hidden URL appears corrupted. It must be a password-protected Link Lock URL. <a href=\"https://ephere-football.github.io/link-lock\">Click here to add a password.</a>");
    return;
...
function main() {
  if (window.location.hash) {
    document.querySelector("#encrypted-url").value =
      `https://ephere-football.github.io/link-lock/${window.location.hash}`;
